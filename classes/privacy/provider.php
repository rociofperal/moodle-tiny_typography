...
/**
 * Privacy provider for the Tiny Typography plugin.
 *
 * The plugin only reads site level configuration and stores nothing about
...
namespace tiny_typography\privacy;
